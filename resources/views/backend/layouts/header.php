        ...
        <div class="responsive-header">
            ...
            <div class="responsive-opensec">
                ...
                <div class="responsivemenu">
                    <ul>
                        <li class="menu-item-has-children"><a href="index.php" title="Home">Home</a></li>
        ...
        <header class="stick-top forsticky">
            <div class="topbar">
                    <div class="container">
                        ...
                        <div class="h-contact">
                            <span><i class="fa fa-phone"></i>Call us 0850 3256 98 65 </span>
                            <span><i class="fa fa-envelope-o"></i>info@jobhunt.com </span>
                        </div>
                    </div>
                </div>
            <div class="menu-sec">
